      ...
      <div class="container mt-5">
         <?php
            ...
            if(!empty($_POST["send"])){
                ...
                //$sent_data = $_POST["sent_data"];
    
                //Store contactor data in database
              $sql = $connection ->query("INSERT INTO contacts_list(name, email, phone, company, website, message, sent_data)
              VALUES('{$name}','{$email}','{$phone}','{$company}','{$website}','{$message}', now())");
              } 
            ?>
         <!-- Messge -->
